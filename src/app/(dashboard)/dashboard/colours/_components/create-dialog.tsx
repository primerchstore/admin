import { usePostColour } from "@/app/(dashboard)/dashboard/colours/_components/query";
...
import { ColourPostValidationType } from "@/fromServer/helpers/types/colour.type";
...
export default function CreateColourDialog() {
  const [colourData, setColourData] = useState<ColourPostValidationType>({
    hexCode: "#000000",
    name: "",
  });
  const { mutate } = usePostColour();
